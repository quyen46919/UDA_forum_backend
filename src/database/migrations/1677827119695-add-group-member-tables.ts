...
export class addGroupMemberTables1677827119695 implements MigrationInterface {
    name = 'addGroupMemberTables1677827119695'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`groups\` (\`id\` varchar(36) NOT NULL, \`created_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`name\` varchar(100) NOT NULL, \`imageUrl\` varchar(255) NOT NULL, \`logo\` varchar(255) NOT NULL, \`qrCode\` varchar(255) NOT NULL, \`inviteCode\` varchar(255) NOT NULL, \`meetingLink\` varchar(255) NOT NULL, \`subMeetingLink\` varchar(255) NOT NULL, \`deleted_at\` timestamp(6) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
