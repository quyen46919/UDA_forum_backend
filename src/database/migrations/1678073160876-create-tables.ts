...
export class createTables1678073160876 implements MigrationInterface {
    name = 'createTables1678073160876'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`groups\` (\`id\` varchar(36) NOT NULL, \`created_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`name\` varchar(100) NOT NULL, \`image_url\` varchar(255) NOT NULL, \`logo\` varchar(255) NOT NULL, \`qr_code\` varchar(255) NULL, \`invite_code\` varchar(255) NULL, \`meeting_link\` varchar(255) NOT NULL, \`sub_meeting_link\` varchar(255) NULL, \`deleted_at\` timestamp(6) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
