...
export class createTables1678093550307 implements MigrationInterface {
    name = 'createTables1678093550307'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`group_members\` CHANGE \`outDate\` \`outDate\` timestamp(0) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`group_members\` CHANGE \`joinDate\` \`joinDate\` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP()`);
