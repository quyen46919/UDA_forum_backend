...
export class fixTables1675398267542 implements MigrationInterface {
    name = 'fixTables1675398267542'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`answers\` (\`id\` varchar(36) NOT NULL, \`created_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`content\` longtext NOT NULL, \`count\` int NOT NULL, \`document_link\` varchar(255) NOT NULL, \`is_correct_answer\` tinyint NOT NULL COMMENT '0: NOTHING | 1: WRONG | 2: CORRECT', \`is_hidden\` tinyint NOT NULL COMMENT '0: FALSE | 1: TRUE' DEFAULT '0', \`deleted_at\` timestamp(6) NULL, \`create_user_id\` varchar(36) NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
