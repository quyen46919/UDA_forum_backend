...
export class createTables1675068597206 implements MigrationInterface {
    name = 'createTables1675068597206'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`user_tokens\` DROP COLUMN \`token\``);
        await queryRunner.query(`ALTER TABLE \`user_tokens\` ADD \`token\` varchar(512) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`user_tokens\` DROP COLUMN \`refresh_token\``);
        await queryRunner.query(`ALTER TABLE \`user_tokens\` ADD \`refresh_token\` varchar(512) NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`user_tokens\` CHANGE \`expire_at\` \`expire_at\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP()`);
        await queryRunner.query(`ALTER TABLE \`user_tokens\` DROP COLUMN \`refresh_token\``);
        await queryRunner.query(`ALTER TABLE \`user_tokens\` ADD \`refresh_token\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`user_tokens\` DROP COLUMN \`token\``);
        await queryRunner.query(`ALTER TABLE \`user_tokens\` ADD \`token\` varchar(255) NOT NULL`);
