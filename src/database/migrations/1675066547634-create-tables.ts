...
export class createTables1675066547634 implements MigrationInterface {
    name = 'createTables1675066547634'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`user_tokens\` ADD \`refresh_expire_at\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`user_tokens\` DROP COLUMN \`refresh_expire_at\``);
    }
