...
export class createQuestionTables1675011856913 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX \`IDX_8d6a2354aab6a596e9ac2fb136\` ON \`user_question_actions\``);
        await queryRunner.query(`ALTER TABLE \`tags\` ADD \`is_hidden\` tinyint NOT NULL COMMENT '0: FALSE | 1: TRUE'`);
        ...
        await queryRunner.query(`ALTER TABLE \`user_tokens\` CHANGE \`type\` \`type\` tinyint NOT NULL COMMENT '0: ADMIN | 1: STUDENT | 2: LECTURE'`);
        await queryRunner.query(`ALTER TABLE \`user_tokens\` CHANGE \`userId\` \`userId\` varchar(36) NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`users\` CHANGE \`role\` \`role\` tinyint NOT NULL COMMENT '0: ADMIN | 1: STUDENT | 2: LECTURE'`);
        ...
        await queryRunner.query(`ALTER TABLE \`user_question_actions\` CHANGE \`action_type\` \`action_type\` tinyint NOT NULL COMMENT '0: NOTHING | 1: LIKE | 2: DISLIKE'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`user_tokens\` DROP FOREIGN KEY \`FK_92ce9a299624e4c4ffd99b645b6\``);
        await queryRunner.query(`ALTER TABLE \`question_images\` DROP FOREIGN KEY \`FK_ff54078f094e7ef1353f215021f\``);
        await queryRunner.query(`ALTER TABLE \`user_question_actions\` CHANGE \`action_type\` \`action_type\` tinyint NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`user_tokens\` CHANGE \`userId\` \`userId\` varchar(36) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`user_tokens\` CHANGE \`type\` \`type\` tinyint NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`user_tokens\` ADD CONSTRAINT \`FK_92ce9a299624e4c4ffd99b645b6\` FOREIGN KEY (\`userId\`) REFERENCES \`users\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE \`questions\` CHANGE \`is_hidden\` \`is_hidden\` tinyint NOT NULL`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX \`IDX_8d6a2354aab6a596e9ac2fb136\` ON \`user_question_actions\` (\`questionId\`)`);
    }
