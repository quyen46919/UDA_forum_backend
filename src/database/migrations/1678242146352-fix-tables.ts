...
export class fixTables1678242146352 implements MigrationInterface {
    name = 'fixTables1678242146352'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`group_boards\` DROP COLUMN \`color\``);
        await queryRunner.query(`ALTER TABLE \`group_boards\` ADD \`color\` varchar(50) NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`group_boards\` DROP COLUMN \`color\``);
        await queryRunner.query(`ALTER TABLE \`group_boards\` ADD \`color\` varchar(7) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`group_attendances\` CHANGE \`time\` \`time\` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP()`);
